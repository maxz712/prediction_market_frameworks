...
class TestPolymarketClient:
    ...
    def test_get_events_delegation(
        self, mock_get_events, test_config, sample_event_data
    ):
    ...
    def test_get_market_delegation(
        self, mock_get_market, test_config, sample_market_data
    ):
    ...
    def test_client_has_expected_methods(self, test_config):
        ...
        expected_methods = [
            ...
            "get_market",
            "get_order_book",
            "get_user_market_trades_history",
            "get_prices_history",
            "cancel_order",
            "cancel_orders",
            "cancel_all_orders",

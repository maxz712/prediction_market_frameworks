...
class LimitOrderRequest(BaseModel):
    ...
    expires_at: Optional[int] = Field(None, description="Expiration timestamp for GTD orders")
...
class OrderResponse(BaseModel):
    ...
    order: Optional[Order] = Field(None, description="Full order details if available")
    ...
    # Market details
    market_id: Optional[str] = Field(None, description="Market identifier")
